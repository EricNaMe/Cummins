...
<html>
    ...
    <body>
        ...
        <div class="table-responsive" style="margin: 20px; height: 850px;">
            <div class="container-body">
                    ...
                    <div style="width:200px; position:relative;  left:40px; top:0px; margin: 0px; height: 25px;">
                        ...
                        <div style="width:250px; position:relative; top:-24px; left:20px;"> 
                            ...
                            <label class="checkbox-inline">
                                <input type="checkbox" name="optradio" value="">Evaluación
                            </label>

                            <label class="checkbox-inline">
                                <input type="checkbox" name="optradio" value="">Pre Evaluación
                            </label>
                        </div> 
                ...
                <div class="modal-body">
                    <div class="col-sm-3 form-inline">
                        ...
                        <div style="">
                            ...
                            <input type="text" readonly style="background-color:#ffffff;" class="form-control" id="oem">
                        </div>
                    </div>
                    <div class="col-sm-3 form-inline">
                        <div style="  margin-bottom: 15px;">
                        ...
                        <div style="  margin-bottom: 15px;">
                            ...
                            <input type="text" readonly style="background-color:#ffffff;" id="codigoDeal" size="4" class="form-control"><br>
                        </div>
                        <div style="  margin-bottom: 15px;">
                            <label>Fronterizo:</label>&nbsp;
                            <input style="  margin-left: 28px;" type="text" size="2" class="form-control"><br>
                        </div>
                        <div style="">
                            <label>No. de Bahias:</label>&nbsp;
                            <input style="  margin-left: 4px;" type="text" size="1" class="form-control"><br>
                        </div>
                    </div>
                ...
                <div class="container" style=" position:relative; top:40px; height: 50px; width:1200px;">
                    <div style="" class="col-sm-3 form-inline">
                        <label>No. mecanicos promotion:</label>&nbsp;
                        <input style="width:44px;" type="text" class="form-control" size="1" >
                    </div>
                    <div style="   display:inline-block; " class=" form-inline">
                        <label>No. de mecanicos:</label>&nbsp;
                        <input style="width:44px;" type="text" class="form-control" size="1" >
                    </div>
                    <div style="display:inline-block; " class="form-inline">
                        <label>No. de ayudantes:</label>&nbsp;
                        <input style="width:44px;" type="text" class="form-control" size="1" >
                    </div>
                </div>    
